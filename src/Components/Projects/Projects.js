...
function Projects() {
  ...
  return (
    <div id="Experiences" className={`p-5 my-5`}>
      ...
      <div
        className={`flex flex-row flex-wrap justify-between p-5 text-center`}
      >
        <a
          href="https://udacity-mimic.netlify.app"
          target={"_blank"}
          className="w-[45%] scale-up my-4"
        >
        ...
        >
          <div className={`flex flex-col rounded-xl ${colors.cardBg}`}>
            ...
            <p className={` text-center ${colors.secText} capitalize p-4`}>
              This project was a submission for MyUniversity. It is a vanilla
              website with a server that uses spotify API to embed podcasts into
              the website (Due to spotify terms, the website can't use their
              Full API for free. but you can download the source code to check
              the server and use your own API keys to try it yourself!)
            </p>
          </div>
        </a>
        ...
        >
          <div className={`flex flex-col rounded-xl ${colors.cardBg}`}>
            ...
            <p className={` text-center ${colors.secText} capitalize p-4`}>
              This project was a submission for Udacity's front-end professional
              nanodegree. It is a simple book tracking app that you can add your
              books on it and search for new books using a third party API
            </p>
          </div>
        </a>
      </div>
